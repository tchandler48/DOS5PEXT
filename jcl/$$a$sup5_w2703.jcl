* $$ JOB JNM=$$A$SUP5,CLASS=0 
* $$ LST LST=00E,FNO=1PT6,CLASS=A
// JOB $$A$SUP5 GEN $$A$SUP5                                            00002*16
// OPTION CATAL 
...
* PAGE DATASET DEFINITION
         DPD                                                           X
               UNIT=X'150',        DPD DEVICE                          X
               VOLID=SYSRES,       DPD VOLID                           X
               CYL=400             DPD LOCATION
         SPACE
         SEND
         GENSUPVR                                                       00263**5
         END                                                            00264**5
