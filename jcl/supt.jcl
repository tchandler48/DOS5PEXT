* $$ JOB JNM=$$A$SUPT,CLASS=0,USER='DOSVS5P-v1r0m1'
* $$ LST CLASS=A,DISP=D,JSEP=1
// JOB $$A$SUPT GEN $$A$SUPT
// OPTION CATAL                                                         00017**5
// EXEC ASSEMBLY,SIZE=192K                                              00018**5
         PRINT GEN
         SPACE
         MACRO                                                          00019**5
         GENSUPVR                                                       00020**5
         SUPVR AP=YES,                                                 *00021**5
               ...
               ERRLOG=YES,                                             *00023**5
               EU=NO,                                                  *00024**5
               ID=T,            SUPERVISOR ID => $$A$SUPT              *00025*16
               MICR=NO,                                                *00026**5
               NPARTS=5,                                               *00027**5
               PAGEIN=5,                                               *00028**5
               PHO=YES,                                                *00029**5
               POWER=YES,                                              *00030**5
               TP=(BTAM,VTAM)                                           00031**5
         ...
         FOPT  AB=YES,                                                 *00042**5
               ...
               TOD=YES,                                                *00067**5
               TTIME=F2,                                               *00068**5
               USERID=SUPTR3402/18/10,                                 *00069*17
               VSAM=YES,                                               *00070**5
               WAITM=YES,                                              *00071**5
               XECB=YES,                                               *00072**5
         ...
         VSTAB RSIZE=4096K,                                            *00078**7
               VSIZE=12188K,                                           *00079*17
               BUFSIZE=160,                                            *00080**5
               SVA=(1024K,128K)                                         00081**5
         ALLOC F4=1024K,                                               *00082**5
               F3=2048K,                                               *00083**5
               F2=2048K,                                               *00084*17
               F1=512K                                                  00085**5
         ...
         DVCGEN CHUN=X'440',DVCTYP=3350
         DVCGEN CHUN=X'441',DVCTYP=3350
         DVCGEN CHUN=X'442',DVCTYP=3350
         DVCGEN CHUN=X'443',DVCTYP=3350
         DVCGEN CHUN=X'444',DVCTYP=3350
         DVCGEN CHUN=X'445',DVCTYP=3350
         DVCGEN CHUN=X'446',DVCTYP=3350
         DVCGEN CHUN=X'447',DVCTYP=3350
         ...
         ASSGN SYS001,X'362',BG                                         00232*12
         ASSGN SYS001,X'362',F4                                         00233*12
         ASSGN SYS001,X'362',F3                                         00234*12
         ASSGN SYS001,X'362',F2                                         00235*12
         ASSGN SYS001,X'362',F1
         ASSGN SYS002,X'362',BG                                         00236*12
         ASSGN SYS002,X'362',F4                                         00237*12
         ASSGN SYS002,X'362',F3                                         00238*12
         ASSGN SYS002,X'362',F2                                         00239*12
         ASSGN SYS002,X'362',F1
         ASSGN SYS003,X'362',BG                                         00240*12
         ASSGN SYS003,X'362',F4                                         00241*12
         ASSGN SYS003,X'362',F3                                         00242*12
         ASSGN SYS003,X'362',F2                                         00243*12
         ASSGN SYS003,X'362',F1
         ASSGN SYSLNK,X'362',BG                                         00244*12
         ASSGN SYSLNK,X'362',F4                                         00245*12
         ASSGN SYSLNK,X'362',F3                                         00246*12
         ASSGN SYSLNK,X'362',F2                                         00247*12
